...
urlpatterns = [
    ...
    path('play/leaderboard/', views.leaderboard_view, name='leaderboard'),  # Leaderboard
    path('play/register/', views.register_view, name='register'),  # Registration
    path('play/login/', views.login_view, name='login'),  # Login
    path('play/logout/', views.logout_view, name='logout'),  # Logout
